...
splitting attack and LR on the lower layer.
"""
...
def main():
    ...
    while(1):
        ...
        # Use an LR as a predictor for lower layer
        model_down = pypuf.attack.LRAttack2021(
            train_crps_down, args.seed, k=args.k_down, epochs=30, lr=.001,
            bs=1000, stop_validation_accuracy=.97)
